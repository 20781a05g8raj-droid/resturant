      ...
      <div className="max-w-7xl mx-auto px-4 -mt-20 relative z-20 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          >
             ...
             {formStatus === 'success' ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="group relative">
                        <select className="w-full bg-transparent border-b border-stone-300 py-3 text-stone-800 outline-none focus:border-gold-500 transition-all cursor-pointer">
          ...
          >
            ...
            {/* Opening Hours */}
             <div className="bg-stone-900 text-white p-8 shadow-2xl relative overflow-hidden rounded-sm group">
